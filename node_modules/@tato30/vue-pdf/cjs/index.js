...
var script = {
  ...
  setup(props, context){
    ...
    const TextlayerREF = vue.ref({});
    const AnnotationlayerREF = vue.ref({});
        ...
        page.render(renderContext).promise.then(() => {
          ...
          if (props.textLayer) {
            page.getTextContent().then(textContent => {
              ...
              const TextLayerBuilder = new PDFJSViewer__namespace.TextLayerBuilder({
                textLayerDiv: TextlayerREF.value, 
                pageIndex: page._pageIndex,
                eventBus: new PDFJSViewer__namespace.EventBus(),
                viewport: viewport,
          ...
          if (props.annotationLayer) {
            ...
            page.getAnnotations().then(annotations => {
              ...
              PDFJSlib__namespace.AnnotationLayer.render({
                ...
                page: page,
                linkService: new PDFJSViewer.SimpleLinkService(), // no pdfviewer features needed, send void LinkService
    ...
    vue.watch(() => props.textLayer, (textLayer) => {
      if (textLayer) {
    ...
    vue.watch(() => props.annotationLayer, (annotationLayer) => {
      if (annotationLayer){
    ...
    vue.watch(() => props.annotationsFilter, () => {
      clearLayers();
      renderPage(props.page);
    });

    vue.watch(() => props.scale, (_) => {
      // When scale change rework render task
      clearLayers();
      renderPage(props.page);
    });

    vue.watch(() => props.rotation, (_) => {
      // When rotation change rework render task
      clearLayers();
      renderPage(props.page);
    });

    vue.watch(() => props.page, (page) => {
